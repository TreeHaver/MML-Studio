...
| Instrument cards, add/select/collapse, Rename, preset switching and Mute/Solo | [instruments.ts](../src/instruments.ts), `state.ts` | [renderer](../tests/renderer.test.cjs), [electron-instruments](../tests/electron-instruments.cjs), [electron-ui](../tests/electron-ui.cjs) |
...
| Active-instrument yellow density regions/ruler markers | [rendering/note-density.ts](../src/rendering/note-density.ts), pure [music/note-density.ts](../src/music/note-density.ts) | [note-density](../tests/note-density.test.mjs), [renderer](../tests/renderer.test.cjs) |
...
| Per-instrument MML cache, real-time/manual updates, warning marker, pop-out sync | [mml.ts](../src/mml.ts); mounted by `instruments.ts` / `instrument-actions.ts` | [renderer](../tests/renderer.test.cjs), [electron-mml](../tests/electron-mml.cjs) |
