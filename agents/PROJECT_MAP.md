...
| Drop MIDI/MML/text files as new instruments | [drop-files.ts](../src/drop-files.ts) owns browser files, async guards, history/scope and commit; [import/source.ts](../src/import/source.ts) shares MIDI/MML dispatch; [import/append.ts](../src/import/append.ts) remaps new lanes/IDs | [midi-import](../tests/midi-import.test.mjs), [renderer](../tests/renderer.test.cjs), [electron-midi-import](../tests/electron-midi-import.cjs) |
