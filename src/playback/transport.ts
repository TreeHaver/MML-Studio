...
function buttons(){
 const canPlay=playable();const play=$('play') as HTMLButtonElement;
 play.disabled=!canPlay||phase==='loading'||phase==='playing';play.title=phase==='paused'?'Resume':'Play';play.setAttribute('aria-label',play.title);
