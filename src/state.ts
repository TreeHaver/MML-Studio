...
export const state:EditorState={project:fresh(),segment:null,active:0,selection:new Set(),tool:'draw',zoom:3,topPitch:127,bottomPitch:0,history:[],future:[],gesture:null,dirty:false,saved:'',width:900,height:600,previewPitch:null};
