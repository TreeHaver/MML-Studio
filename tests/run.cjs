...
try {
  ...
  const tests = spawnSync(process.execPath, ['--experimental-vm-modules', '--test', testFile, 'tests/renderer.test.cjs', 'tests/playback.test.mjs', 'tests/preview.test.cjs', 'tests/midi-import.test.mjs', 'tests/timeline.test.mjs', 'tests/mml.test.mjs', 'tests/simplify-timing.test.mjs', 'tests/remove-overlap.test.mjs', 'tests/mml-import.test.mjs', 'tests/structure.test.mjs', 'tests/pitch-layout.test.mjs', 'tests/note-visibility.test.mjs', 'tests/segment-view.test.mjs', 'tests/sheets.test.mjs', 'tests/note-density.test.mjs', 'tests/instrument-operations.test.mjs'], { stdio: 'inherit' });
