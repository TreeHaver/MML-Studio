...
export function instruments() {
    ...
    state.project.instruments.forEach((i, index) => {
        ...
        button.textContent = i.name + (instrumentView.muted.has(index) ? ' (muted)' : '');
        ...
        const addPreset = (value, label, vanilla) => {
            ...
            if (value === selected)
                preset.classList.toggle('preset-warning', warning);
    ...
    if (!state.project.instruments.some(i => i.isInstructions))
