...
function visibleNotes() {
    ...
    return query(view.scrollLeft / state.zoom, (view.scrollLeft + state.width - KEY) / state.zoom, pitchAtY(state.topPitch, view.scrollTop + state.height - HEAD), pitchAtY(state.topPitch, view.scrollTop), 48 / state.zoom);
}
